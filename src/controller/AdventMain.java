...
//  - - - -  Location Enums  - - - -  //
	...
	public enum Locations
	{
		...
		ALIKE1(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE2(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE3(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE4(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE5(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE6(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE7(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE8(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	 ALIKE9(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE10(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE11(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE12(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE13(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),	ALIKE14(AdventMain.ALIKE_T, AdventMain.ALIKE_PASSAGES),
		...
		DEAD0(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD1(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD2(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD3(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD4(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD5(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD6(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD7(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD8(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD9(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD10(AdventMain.DEAD_END_T, AdventMain.DEAD_END),	DEAD11(AdventMain.DEAD_END_T, AdventMain.DEAD_END),
