...
public class AdventMain 
{
	...
	public static final String 		empty 			= "",
							 		alikePassages	= "You are in a maze of twisty little passages, all alike.",
									alikeT 			= "Maze All Alike",
							 		diffT 			= "Maze All Different",
							 		secretCanyon 	= "Secret Canyon",
							 		deadEnd 		= "Dead end.",
							 		deadEndT 		= "Dead End",
							 		okay 			= "Okay.",
							 		dontHave 		= "You are not carrying it!",
