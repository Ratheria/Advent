...
public class HashMaps 
{
	...
	private void setUpHashMaps()
	{
		...
		longDescription.put(Location.WESTFISSURE, "You are on the west side of the fissure in the hall of mists.");
		...
		longDescription.put(Location.JUMBLE, "You are in a jumble of rock, with cracks everywhere.");
		...
		longDescription.put(Location.DIRTY, "You are in a dirty broken passage. To the east is a crawl.  To the west is a large passage. Above you is another passage.");
		...
		longDescription.put(Location.BEDQUILT, "You are in bedquilt, a long east/west passage with holes everywhere. To explore at random select north, south, up or down.");
		longDescription.put(Location.CHEESE, "You are in a room whose walls resemble swiss cheese. Obvious passages go west, east, ne, and nw. Part of the room is occupied by a large bedrock block.");
		...
		longDescription.put(Location.TIGHT, "The canyon here becomes too tight to go further south.");
